    ...
    <div class="row justify-content-center">
        <div class="col-lg-9">
            <div class="text-center mb-5">
                <h2 class="fw-bold" style="font-family: 'Playfair Display'; color: #8b6262;">Panduan & FAQ Barter</h2>
                    ...
                    <div id="statusMeaning" class="accordion-collapse collapse" data-bs-parent="#barterGuide">
                        <div class="accordion-body bg-white small">
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2"><span class="badge bg-danger"> REJECTED</span>: Partner menolak penawaranmu.</li>
                                ...
                                <li class="mb-2"><span class="badge bg-danger"> REJECTED QC</span>: Admin membatalkan barter karena barang tidak lolos pemeriksaan.</li>
                                <li class="mb-2"><span class="badge bg-secondary">CANCELLED</span>: Barter dibatalkan oleh salah satu pihak sebelum dikirim.</li>
                                <li class="mb-2"><span class="badge bg-info text-dark">COMPLETED</span>: Proses barter telah selesai, barang sudah diterima!</li>
                            </ul>
                        </div>
                    </div>
                </div>
