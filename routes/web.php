...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::post('/barters/reject-qc/{id}', [AdminBarterController::class, 'rejectQC'])->name('barter.reject-qc');
    });
});
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // CHAT SYSTEM (Opsi B: Per Barter ID)
    Route::get('/chat', [ChatController::class, 'index'])->name('chat.index');    
    Route::get('/chat/user/{user_id}/barter/{barter_id}', [ChatController::class, 'show'])->name('chat.show');
    ...
    Route::get('/barter-guide', function () {return view('customer.barter.guide');})->name('barter.guide');
